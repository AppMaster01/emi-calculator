...
class BackButtonController extends GetxController {
  ...
  showBackbuttonad(BuildContext context, String name, var arg) async {
    if (Calculator.value["BACKCOUNTER"] == Backbuttoncounter.value) {
      print(Calculator.value[name]["INTER_AD_TYPE"]);
      showDialog(
      ...
      if (Calculator.value[name]["INTER_AD_TYPE"] == 'ADMOB') {
        InterstitialAd.load(
          adUnitId: Calculator.value[name]["INTER_ADMOB"],
          ...
          adLoadCallback: InterstitialAdLoadCallback(onAdLoaded: (ad) {
            ...
            InterstitialAd.load(
              adUnitId: Calculator.value["interstitial"],
              // adUnitId: "/6499/example/interstitial",
              request: const AdManagerAdRequest(),
              adLoadCallback: InterstitialAdLoadCallback(onAdLoaded: (ad) {
                ad.show();
      ...
      if (Calculator.value[name]["INTER_AD_TYPE"] == 'FB') {
        print("ads loading");
        FacebookInterstitialAd.loadInterstitialAd(
          placementId: Calculator.value["INTER_FB"],
      ...
      if (Calculator.value[name]["INTER_AD_TYPE"] == "URL") {
        // log("Loading");
