...
class NativeAds extends GetxController {
  ...
  Widget getNT(context, String name, String Factoryid) {
    ...
    if (Calculator.value[name]["N_AD_TYPE"] == "ADMOB") {
      nativeAd = NativeAd(
        request: const AdManagerAdRequest(),
        adUnitId: Calculator.value[name]["N_ADMOB"],
    ...
    return Calculator.value[name]["N_AD_TYPE"] == "ADMOB"
        ? Obx(() => isLoaded.value
            ? Factoryid == "listTile"
                ? Center(
                    child: Padding(
                      ...
                      children: [
                        Container(
                          width: ScreenSize.horizontalBlockSize! *
                              Calculator.value['width'],
                          height: ScreenSize.horizontalBlockSize! *
                              Calculator.value["Mdiumheight"],
                          decoration: ShapeDecoration(
                            color: Colors.white,
                            shape: RoundedRectangleBorder(
                              side: BorderSide(
        ...
        : Calculator.value[name]["N_AD_TYPE"] == "FB"
            ? Padding(
                ...
                child: Container(
                    ...
                    child: FacebookNativeAd(
                      placementId: Calculator.value["N_FB"],
            ...
            : GestureDetector(
                onTap: () {
                  _launchURL(Calculator.value[name]["URL"]);
                },
                child: Stack(
                  children: [
                    Container(
...
class BannerAds extends GetxController {
  ...
  Widget getBN(String name) {
    if (Calculator.value[name]["B_AD_TYPE"] == "ADMOB") {
      bannerAd = BannerAd(
        size: AdSize.fluid,
        adUnitId: Calculator.value[name]["B_ADMOB"],
    ...
    return Calculator.value[name]["B_AD_TYPE"] == "ADMOB"
        ? Align(
        ...
        : Align(
            ...
            child: Container(
              ...
              child: FacebookBannerAd(
                placementId: Calculator.value["B_FB"],
